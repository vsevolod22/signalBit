...
export function MainHero(): ReactElement {
  ...
  return (
    <motion.section className="hero" id="top" aria-labelledby="hero-title" initial="hidden" animate="visible" variants={pageSectionVariants}>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
      >
        <img src={content.hero.arrowImage} alt="" />
      </motion.a>
    </motion.section>
  );
}
