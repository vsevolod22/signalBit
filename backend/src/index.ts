...
import trainingCharacteristics from './data/training-characteristics.json';
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        headline: 'БАС',
        slideType: 'catalog',
        slideSubtitle: 'учебные',
        lead:
          'Базовые наборы учебных беспилотных летательных аппаратов позволят обучить навыкам пилотирования, сборки, настройки и программирования БАС.',
        ...
        catalogItems: [
          {
            ...
            kitItems: [
              { title: 'полетный контроллер – 1 шт.', sortOrder: 10 },
              { title: 'блок инерциальной навигационной системы – 1 шт.', sortOrder: 20 },
              { title: 'плата распределения питания – 1 шт.', sortOrder: 30 },
              { title: 'регуляторы скорости – 4 шт.', sortOrder: 40 },
              { title: 'рама – 1 шт.', sortOrder: 50 },
              { title: 'аккумулятор – 1 шт.', sortOrder: 60 },
              { title: 'зарядное устройство – 1 шт.', sortOrder: 70 },
              { title: 'приемник – 1 шт.', sortOrder: 80 },
              { title: 'набор FPV (шлем/приемник + передатчик) – 1 шт.', sortOrder: 90 },
              { title: 'камера – 1 шт.', sortOrder: 100 },
              { title: 'встроенное программное обеспечение полётного контроллера', sortOrder: 110 },
            ],
            priceLabel: 'Стоимость',
            price: 'от 45 000 руб.',
            characteristicsButtonLabel: 'Подробные характеристики',
            characteristicsTitle: 'Подробные характеристики — АИСТ',
            characteristics: trainingCharacteristics.aist,
            sortOrder: 10,
          },
          {
            code: 'colibri',
            name: 'КОЛИБРИ',
            description:
              'Отечественный БАС для обучения внешнему пилотированию и пилотированию от первого лица.',
            kitTitle: 'состав набора',
            kitItems: [
              { title: 'полетный контроллер – 1 шт.', sortOrder: 10 },
              { title: 'коллекторные моторы – 4 шт.', sortOrder: 20 },
              { title: 'винты – 4 шт.', sortOrder: 30 },
              { title: 'рама – 1 шт.', sortOrder: 40 },
              { title: 'аккумулятор – 1 шт.', sortOrder: 50 },
              { title: 'зарядное устройство – 1 шт.', sortOrder: 60 },
              { title: 'встроенное программное обеспечение полётного контроллера', sortOrder: 70 },
            ],
            priceLabel: 'Стоимость',
            price: 'от 20 000 руб.',
            characteristicsButtonLabel: 'Подробные характеристики',
            characteristicsTitle: 'Подробные характеристики — КОЛИБРИ',
            characteristics: trainingCharacteristics.colibri,
            sortOrder: 20,
          },
          {
            code: 'colibri-fpv',
            ...
            kitItems: [
              ...
              { title: 'аккумулятор – 1 шт.', sortOrder: 50 },
              { title: 'зарядное устройство – 1 шт.', sortOrder: 60 },
              { title: 'набор FPV (шлем/приемник + передатчик) – 1 шт.', sortOrder: 70 },
              { title: 'камера – 1 шт.', sortOrder: 80 },
              { title: 'встроенное программное обеспечение полётного контроллера', sortOrder: 90 },
            ],
            priceLabel: 'Стоимость',
            price: 'от 20 000 руб.',
            characteristicsButtonLabel: 'Подробные характеристики',
            characteristicsTitle: 'Подробные характеристики — КОЛИБРИ FPV',
            characteristics: trainingCharacteristics.colibriFpv,
            sortOrder: 30,
          },
        ],
      },
